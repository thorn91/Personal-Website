    ...
    <div class="relative pt-6 pb-16 sm:pb-24 sm:pt-16">
      ...
      <div class="mt-16 mx-auto max-w-7xl px-4 sm:mt-24">
        <div class="text-center">
          ...
          >
            <span class="block xl:inline text-personal-dark">Thomas Horn</span>
          </h1>
          <p
          ...
          <div class="mt-5 max-w-md mx-auto sm:flex sm:justify-center md:mt-8">
            <div class="rounded-md shadow">
              <a
                href="#"
                class="w-full flex items-center justify-center px-8 py-3 border border-transparent text-base font-medium rounded-md text-white bg-personal-dark hover:bg-indigo-700 md:py-4 md:text-lg md:px-10"
              >
                Get started
              </a>
            </div>
